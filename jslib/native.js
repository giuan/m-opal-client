...
if (value == null) value = nil;
  ...
  (function($base) {
    ...
    Opal.defn(self, '$Array', TMP_12 = function(object) {
  ...
  (function($base, $super) {
    ...
    Opal.defn(self, '$each', TMP_13 = function() {
    ...
    Opal.defn(self, '$method_missing', TMP_14 = function(mid) {
    ...
    Opal.defn(self, '$to_a', TMP_15 = function(options) {
  ...
  (function($base, $super) {
    ...
    Opal.defn(self, '$initialize', TMP_16 = function(native$, options) {
      ...
      TMP_16.$$p = null;
      Opal.find_super_dispatcher(self, 'initialize', TMP_16, null).apply(self, [native$]);
    ...
    Opal.defn(self, '$each', TMP_17 = function() {
  ...
  (function($base, $super) {
    ...
    return (Opal.defn(self, '$to_n', function() {
      ...
      result = {};
      ($a = ($b = self).$each_pair, $a.$$p = (TMP_18 = function(name, value){var self = TMP_18.$$s || this;
if (name == null) name = nil;if (value == null) value = nil;
      return result[name] = value.$to_n();}, TMP_18.$$s = self, TMP_18), $a).call($b);
      return result;
    }), nil) && 'to_n'
  })($scope.base, null);
  (function($base, $super) {
  ...
  (function($base, $super) {
    ...
    Opal.defn(self, '$initialize', TMP_19 = function(defaults) {
