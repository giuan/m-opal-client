...
(function(Opal) {
  ...
  return (function($base) {
    ...
    Opal.defn(self, '$benchmark', TMP_1 = function(caption, label_width, format) {
      var $a, $b, $c, TMP_2, self = this, $iter = TMP_1.$$p, $yield = $iter || nil, sync = nil, report = nil, results = nil, $splat_index = nil;
      ...
      for($splat_index = 0; $splat_index < array_size; $splat_index++) {
        labels[$splat_index] = arguments[$splat_index + 3];
      }
      if (caption == null) {
        caption = ""
      }
...
if (t == null) t = nil;
    ...
    Opal.defn(self, '$bm', TMP_3 = function(label_width) {
      var $a, $b, self = this, $iter = TMP_3.$$p, blk = $iter || nil, $splat_index = nil;

      var array_size = arguments.length - 1;
      if(array_size < 0) array_size = 0;
      var labels = new Array(array_size);
      for($splat_index = 0; $splat_index < array_size; $splat_index++) {
        labels[$splat_index] = arguments[$splat_index + 1];
      }
      if (label_width == null) {
        label_width = 0
      }
...
if (res == null) res = nil;
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$item', TMP_11 = function(label) {
        var $a, $b, self = this, $iter = TMP_11.$$p, blk = $iter || nil, res = nil, $splat_index = nil;

        var array_size = arguments.length - 1;
        if(array_size < 0) array_size = 0;
        var format = new Array(array_size);
        for($splat_index = 0; $splat_index < array_size; $splat_index++) {
          format[$splat_index] = arguments[$splat_index + 1];
        }
        if (label == null) {
          label = ""
        }
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$format', function(format) {
        var $a, $b, TMP_14, $c, $d, TMP_15, $e, $f, TMP_16, $g, $h, TMP_17, $i, $j, TMP_18, $k, $l, TMP_19, $m, $n, TMP_20, $o, self = this, str = nil, $splat_index = nil;
