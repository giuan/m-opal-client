...
if (item == null) item = nil;
  ...
  return (function($base) {
    ...
    Opal.defn(self, '$to_set', TMP_16 = function(klass) {
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        return (Opal.defn(self, '$compile', function() {
          ...
          return self.$push("Opal.udef(self, '$" + (self.$mid()['$[]'](1).$to_s()) + "');");
        }), nil) && 'compile';
      })($scope.base, $scope.get('Base'));
...
Opal.modules["opal/version"] = function(Opal) {
  ...
  return (function($base) {
    ...
    Opal.cdecl($scope, 'VERSION', "0.9.0.beta1")
  })($scope.base)
};
