  ...
  return (function($base) {
    ...
    Opal.defs(self, '$instance_variable_name!', function(name) {
      ...
      if ((($a = /^@[a-zA-Z_][a-zA-Z0-9_]*?$/.test(name)) !== nil && (!$a.$$is_boolean || $a == true))) {
        ...
        self.$raise($scope.get('NameError'), "'" + (name) + "' is not allowed as an instance variable name")
      };
      return name;
    });

    Opal.defs(self, '$valid_method_name?', function(method_name) {
      var self = this;

      method_name = $scope.get('Opal')['$coerce_to!'](method_name, $scope.get('String'), "to_str");
      return /^[a-zA-Z_][a-zA-Z0-9_]*?$/.test(method_name);
    });
  })($scope.base)
};
...
Opal.modules["corelib/module"] = function(Opal) {
  ...
  Opal.add_stubs(['$equal?', '$<', '$attr_reader', '$attr_writer', '$coerce_to!', '$raise', '$=~', '$inject', '$const_get', '$split', '$const_missing', '$to_str', '$===', '$to_proc', '$lambda', '$bind', '$call', '$class', '$append_features', '$included', '$name', '$new', '$to_s', '$__id__']);
...
Opal.modules["corelib/constants"] = function(Opal) {
  ...
  Opal.cdecl($scope, 'RUBY_ENGINE_VERSION', "0.9.0.beta1");
  Opal.cdecl($scope, 'RUBY_RELEASE_DATE', "2015-10-19");
...
Opal.modules["corelib/regexp"] = function(Opal) {
  ...
  Opal.add_stubs(['$nil?', '$[]', '$raise', '$escape', '$options', '$to_str', '$new', '$join', '$coerce_to!', '$!', '$match', '$begin', '$coerce_to', '$call', '$=~', '$attr_reader', '$===', '$inspect', '$to_a']);
  (function($base, $super) {
  ...
  (function($base, $super) {
    ...
    Opal.defn(self, '$match', TMP_1 = function(string, pos) {
      var self = this, $iter = TMP_1.$$p, block = $iter || nil;
      if ($gvars["~"] == null) $gvars["~"] = nil;
...
Opal.modules["corelib/string"] = function(Opal) {
  ...
  (function($base, $super) {
    ...
    Opal.defn(self, '$gsub', TMP_5 = function(pattern, replacement) {try {
      ...
      if (replacement === undefined && block === nil) {
        Opal.ret(self.$enum_for("gsub", pattern))
      }
...
Opal.modules["corelib/enumerable"] = function(Opal) {
  ...
  Opal.add_stubs(['$raise', '$new', '$yield', '$dup', '$enum_for', '$enumerator_size', '$flatten', '$map', '$==', '$destructure', '$respond_to?', '$coerce_to!', '$>', '$*', '$nil?', '$coerce_to', '$ceil', '$/', '$size', '$===', '$<<', '$[]', '$[]=', '$inspect', '$__send__', '$compare', '$<=>', '$to_a', '$lambda', '$call', '$sort!', '$map!', '$first', '$zip']);
  return (function($base) {
    var self = $module($base, 'Enumerable');

    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_3, TMP_6, TMP_8, TMP_11, TMP_12, TMP_14, TMP_15, TMP_16, TMP_17, TMP_18, TMP_20, TMP_22, TMP_24, TMP_26, TMP_27, TMP_28, TMP_30, TMP_32, TMP_33, TMP_35, TMP_36, TMP_38, TMP_39, TMP_40, TMP_41, TMP_42, TMP_44, TMP_46, TMP_48, TMP_50, TMP_52, TMP_57, TMP_58;
...
if (item == null) item = nil;
    ...
    Opal.defn(self, '$each_entry', TMP_17 = function() {
    ...
    Opal.defn(self, '$each_slice', TMP_18 = function(n) {
      ...
      if ((block !== nil)) {
        ...
        return ($a = ($b = self).$enum_for, $a.$$p = (TMP_19 = function(){var self = TMP_19.$$s || this, $a;

        if ((($a = self['$respond_to?']("size")) !== nil && (!$a.$$is_boolean || $a == true))) {
            return ($rb_divide(self.$size(), n)).$ceil()
            } else {
            return nil
          }}, TMP_19.$$s = self, TMP_19), $a).call($b, "each_slice", n)
      };
    ...
    Opal.defn(self, '$each_with_index', TMP_20 = function() {
      ...
      if ((block !== nil)) {
        ...
        return self.$enumerator_size()}, TMP_21.$$s = self, TMP_21), $a).apply($b, ["each_with_index"].concat(Opal.to_a(args)))
      };
    ...
    Opal.defn(self, '$each_with_object', TMP_22 = function(object) {
      ...
      if ((block !== nil)) {
        ...
        return self.$enumerator_size()}, TMP_23.$$s = self, TMP_23), $a).call($b, "each_with_object", object)
      };
    ...
    Opal.defn(self, '$find_all', TMP_24 = function() {
      ...
      if ((block !== nil)) {
        ...
        return self.$enumerator_size()}, TMP_25.$$s = self, TMP_25), $a).call($b, "find_all")
      };
    ...
    Opal.defn(self, '$find_index', TMP_26 = function(object) {
    ...
    Opal.defn(self, '$grep', TMP_27 = function(pattern) {
    ...
    Opal.defn(self, '$group_by', TMP_28 = function() {
      var $a, $b, TMP_29, $c, $d, self = this, $iter = TMP_28.$$p, block = $iter || nil, hash = nil;
      ...
      if ((block !== nil)) {
        ...
        return self.$enumerator_size()}, TMP_29.$$s = self, TMP_29), $a).call($b, "group_by")
      };
    ...
    Opal.defn(self, '$inject', TMP_30 = function(object, sym) {
    ...
    Opal.defn(self, '$lazy', function() {
      ...
      return ($a = ($b = (($scope.get('Enumerator')).$$scope.get('Lazy'))).$new, $a.$$p = (TMP_31 = function(enum$, args){var self = TMP_31.$$s || this, $a;
if (enum$ == null) enum$ = nil;args = $slice.call(arguments, 1);
      return ($a = enum$).$yield.apply($a, Opal.to_a(args))}, TMP_31.$$s = self, TMP_31), $a).call($b, self, self.$enumerator_size());
    });
    ...
    Opal.defn(self, '$max', TMP_32 = function() {
    ...
    Opal.defn(self, '$max_by', TMP_33 = function() {
      ...
      if (block !== false && block !== nil) {
        ...
        return self.$enumerator_size()}, TMP_34.$$s = self, TMP_34), $a).call($b, "max_by")
      };
    ...
    Opal.defn(self, '$min', TMP_35 = function() {
    ...
    Opal.defn(self, '$min_by', TMP_36 = function() {
      ...
      if (block !== false && block !== nil) {
        ...
        return self.$enumerator_size()}, TMP_37.$$s = self, TMP_37), $a).call($b, "min_by")
      };
    ...
    Opal.defn(self, '$minmax', TMP_38 = function() {
    ...
    Opal.defn(self, '$minmax_by', TMP_39 = function() {
    ...
    Opal.defn(self, '$none?', TMP_40 = function() {
    ...
    Opal.defn(self, '$one?', TMP_41 = function() {
    ...
    Opal.defn(self, '$partition', TMP_42 = function() {
      ...
      if ((block !== nil)) {
        ...
        return self.$enumerator_size()}, TMP_43.$$s = self, TMP_43), $a).call($b, "partition")
      };
    ...
    Opal.defn(self, '$reject', TMP_44 = function() {
      ...
      if ((block !== nil)) {
        ...
        return self.$enumerator_size()}, TMP_45.$$s = self, TMP_45), $a).call($b, "reject")
      };
    ...
    Opal.defn(self, '$reverse_each', TMP_46 = function() {
      ...
      if ((block !== nil)) {
        ...
        return self.$enumerator_size()}, TMP_47.$$s = self, TMP_47), $a).call($b, "reverse_each")
      };
    ...
    Opal.defn(self, '$slice_before', TMP_48 = function(pattern) {
      ...
      return ($a = ($b = $scope.get('Enumerator')).$new, $a.$$p = (TMP_49 = function(e){var self = TMP_49.$$s || this, $a;
if (e == null) e = nil;
      ...
      ;}, TMP_49.$$s = self, TMP_49), $a).call($b);
    });

    Opal.defn(self, '$sort', TMP_50 = function() {
      var $a, $b, TMP_51, self = this, $iter = TMP_50.$$p, block = $iter || nil, ary = nil;

      TMP_50.$$p = null;
      ary = self.$to_a();
      if ((block !== nil)) {
        } else {
        block = ($a = ($b = self).$lambda, $a.$$p = (TMP_51 = function(a, b){var self = TMP_51.$$s || this;
if (a == null) a = nil;if (b == null) b = nil;
        return a['$<=>'](b)}, TMP_51.$$s = self, TMP_51), $a).call($b)
      };
      return ary.sort(block);
    });

    Opal.defn(self, '$sort_by', TMP_52 = function() {
      var $a, $b, TMP_53, $c, TMP_54, $d, TMP_55, $e, TMP_56, self = this, $iter = TMP_52.$$p, block = $iter || nil, dup = nil;
      ...
      if ((block !== nil)) {
        ...
        return self.$enumerator_size()}, TMP_53.$$s = self, TMP_53), $a).call($b, "sort_by")
      };
      dup = ($a = ($c = self).$map, $a.$$p = (TMP_54 = function(){var self = TMP_54.$$s || this, arg = nil;

      arg = $scope.get('Opal').$destructure(arguments);
        return [block.$call(arg), arg];}, TMP_54.$$s = self, TMP_54), $a).call($c);
      ($a = ($d = dup)['$sort!'], $a.$$p = (TMP_55 = function(a, b){var self = TMP_55.$$s || this;
if (a == null) a = nil;if (b == null) b = nil;
      return (a[0])['$<=>'](b[0])}, TMP_55.$$s = self, TMP_55), $a).call($d);
      return ($a = ($e = dup)['$map!'], $a.$$p = (TMP_56 = function(i){var self = TMP_56.$$s || this;
if (i == null) i = nil;
      return i[1];}, TMP_56.$$s = self, TMP_56), $a).call($e);
    });
    ...
    Opal.defn(self, '$take_while', TMP_57 = function() {
      var $a, self = this, $iter = TMP_57.$$p, block = $iter || nil;
    ...
    Opal.defn(self, '$zip', TMP_58 = function() {
      var $a, self = this, $iter = TMP_58.$$p, block = $iter || nil;
  ...
  (function($base, $super) {
    ...
    Opal.defn(self, '$bit_length', function() {
      ...
      if ((($a = $scope.get('Integer')['$==='](self)) !== nil && (!$a.$$is_boolean || $a == true))) {
        ...
        self.$raise($scope.get('NoMethodError'), "undefined method `bit_length` for " + (self) + ":Float")
      };
...
Opal.modules["corelib/time"] = function(Opal) {
  ...
  ;
    ...
    Opal.defs(self, '$local', function(year, month, day, hour, min, sec, millisecond) {
      var self = this;
    ...
    Opal.defs(self, '$gm', function(year, month, day, hour, min, sec, millisecond) {
      var self = this;
...
Opal.modules["corelib/struct"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$include', '$==', '$[]', '$upcase', '$const_set', '$new', '$unshift', '$each', '$define_struct_attribute', '$class_eval', '$to_proc', '$allocate', '$initialize', '$raise', '$<<', '$members', '$valid_method_name?', '$define_method', '$[]=', '$instance_eval', '$each_with_index', '$class', '$hash', '$===', '$<', '$-@', '$size', '$>=', '$include?', '$to_sym', '$coerce_to!', '$instance_of?', '$__id__', '$eql?', '$enum_for', '$length', '$map', '$+', '$join', '$inspect', '$each_pair', '$inject', '$flatten', '$to_a']);
  self.$require("corelib/enumerable");
  return (function($base, $super) {
    function $Struct(){};
...
if (arg == null) arg = nil;
    ...
    Opal.defs(self, '$define_struct_attribute', function(name) {
      ...
      self.$members()['$<<'](name);
      if ((($a = $scope.get('Opal')['$valid_method_name?'](name)) !== nil && (!$a.$$is_boolean || $a == true))) {
...
Opal.modules["corelib/unsupported"] = function(Opal) {
  ...
  (function($base, $super) {
    ...
    Opal.defn(self, '$private_class_method', function(name) {
      var self = this;
