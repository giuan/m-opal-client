...
if (value == null) value = nil;
  ...
  Opal.defn(Opal.Object, '$OBx', function(obj) {
    var self = this;
  ...
  (function($base, $super) {
    function $OBxAll(){};
    var self = $OBxAll = $klass($base, $super, 'OBxAll', $OBxAll);

    var def = self.$$proto, $scope = self.$$scope, TMP_4;

    def.j = nil;
    return (Opal.defn(self, '$method_missing', TMP_4 = function(meth) {var $zuper = $slice.call(arguments, 0);
  ...
  return (Opal.defn(Opal.Object, '$OBxAll', function(obj) {
    var self = this;

    return $scope.get('OBxAll').$new(obj);
  }), nil) && 'OBxAll';
})(Opal);
